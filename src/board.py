...
class Board_state:
    def __init__(self, board, list_of_areas, step):
        ...
        self.empty_count = self.get_empty_count()
        self.row = len(board)
        ...
        try:
            for area in self.list_of_areas:
                if coordinate in area.list_of_coordinates:
                    return area.id
        except: print("Coordinates out of bounds!")    
    ...
    def is_valid_placement(self, coordinate) -> bool:
        ...
        if(self.board[coordinate[0]][coordinate[1]] == 'O' or self.board[coordinate[0]][coordinate[1]] == 'X'):
            return False
    ...
    def __lt__(self, other): 
        return self.empty_count + self.step < other.empty_count + other.step